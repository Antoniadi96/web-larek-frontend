...
- _title: string - заголовок продукта
- _imageUrl: string - URL изображения продукта
- _price: number - цена продукта
...
- basketData: BasketData - экземпляр класса для работы с данными корзины
- element: HTMLElement - корневой HTML-элемент для рендеринга
